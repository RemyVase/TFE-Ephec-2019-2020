$(document).ready(function () {
    ...
    $("#ajoutAnimal_form").submit(function (event) {
        ...
        var dataForm = getAllElementsForm("#ajoutAnimal_form");

        dataForm.append('fileAnimal', $('#imageAnimal')[0].files[0]);
        var res = check_form("nomAnimal");
        res = check_form("ageAnimal") && res;
        res = check_form("villeAnimal") && res;
        res = check_form("descAnimal") && res;
        res = check_form("imageAnimal") && res;
        if (!res) return;
