        ...
        <div class="container">
            <div class="portfolio_details_inner">
                <div class="row">
                    <div class="col-md-5">
                        <div class="left_img">
                            <img class="img-fluid" src="<?= $detailsAssoc{
                                                            0}["img"]; ?>" alt="">
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="portfolio_right_text">
                            <h4><?= $detailsAssoc{
                                    0}["nom_assoc"]; ?></h4>
                            <ul class="list">
                                <li><span>Adresse</span>: <?= $detailsAssoc{
                                                                0}["adresse_assoc"]; ?></li>
                                <li><span>Numéro de téléphone</span>: <?= $detailsAssoc{
                                                                            0}["tel_assoc"]; ?></li>
                                <li><span>Email</span>: <?= $detailsAssoc{
                                                            0}["email_assoc"]; ?></li>
                                <li><span>Site</span>: <a href="<?= $detailsAssoc{
                                                                    0}["site_assoc"]; ?>"><?= $detailsAssoc{
                                                                                            0}["site_assoc"]; ?></a></li>
                                <li><span>Places animaux en règles</span>: <strong><?= $detailsAssoc{
                                                                                        0}["nbPlaceRegle_assoc"]; ?></strong> </li>
                                <li><span>Places animaux en quarantaine</span>: <strong><?= $detailsAssoc{
                                                                                            0}["nbPlaceQuarant_assoc"]; ?></strong></li></br><br><br>
