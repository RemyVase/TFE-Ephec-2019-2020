			...
			<div class="banner_inner d-flex align-items-center">
				<div class="container">
					<div class="banner_content text-center">
						<h3>Save A Pet and Friends</h3>
						<p>Aidez-nous à offrir une vie meilleure aux animaux errants </p>
						<a class="main_btn" href="#quiSommesNous">Que faisons-nous ?</a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="col-lg-6">
						<div class="h_blog_text">
							<div class="h_blog_text_inner left">
								...
								<p>Save A Pet and Friends est une plateforme web visant à promouvoir le sauvetage, la prise en charge et l’adoption d’animaux errants tout en soutenant les différents organismes de défense des animaux qui, tous les jours, travaillent au service du bien-être animal. </p>
					...
					<div class="col-lg-6">
						<div class="h_blog_text">
							<div class="h_blog_text_inner right">
								...
								<a class="main_btn2" href="lesAssociations.php">Aller vers les associations</a>
					...
					<div class="col-lg-6">
						<div class="h_blog_text">
							<div class="h_blog_text_inner left">
								...
								<a class="main_btn2" href="listeAnimaux.php">Aller à la liste des animaux disponibles à l'adoption</a>
							</div>
						</div>
					</div>
				</div>
				<div class="row h_blog_item">
					<div class="col-lg-6">
						<div class="h_blog_text">
							<div class="h_blog_text_inner right">
								<h4>Faire un don </h4>
								<p>Save A Pet and Friends vous donne l’opportunité de soutenir et venir en aide aux différents organismes qui luttent pour la cause animale en faisant des dons de quelque nature qu’ils soient (matériel à donner, nourriture, soutien financier, etc.).</p>
								...
								<a class="main_btn2" href="donOffre.php">Aller vers la plateforme de dons</a>
							</div>
						</div>
					</div>
					<div class="col-lg-6">
